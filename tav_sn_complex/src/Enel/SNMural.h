...
#ifndef SRC_ENEL_SNMural_H_
#define SRC_ENEL_SNMural_H_
...
class SNMural : public SceneNode
{
public:
    enum drawMode { RAW_DEPTH, DEPTH_THRESH, DEPTH_BLUR, DIFF, DRAW };

	SNMural(sceneData* _scd, std::map<std::string, float>* _sceneArgs);
	virtual ~SNMural();
