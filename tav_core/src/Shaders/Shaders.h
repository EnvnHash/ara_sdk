...
public:
	Shaders();
	Shaders(const char* comp, bool readFromFile);
	Shaders(const char* vert, const char* frag, bool readFromFile);
	Shaders(const char* vert, const char* geom, const char* frag,
			bool readFromFile);
	Shaders(const char* vert, const char* tessCtr, const char* tessEv,
			const char* geom, const char* frag, bool readFromFile = false);
	~Shaders();
	...
	void setUniform2ui(const std::string & name, unsigned int v1,
			unsigned int v2);
	void setUniform3ui(const std::string & name, unsigned int v1,
			unsigned int v2, unsigned int v3);
	void setUniform4ui(const std::string & name, unsigned int v1,
...
private:
	...
	bool checkStatusCompile(GLuint obj);
