...
#include "pch.h"
#include "Cs1Perspective.h"

namespace tav
{
Cs1Perspective::Cs1Perspective(sceneData* _scd, OSCData* _osc) :
		CameraSet(1, _scd, _osc)
{
	...
	cam[0] = new GLMCamera(GLMCamera::FRUSTUM, scrWidth, scrHeight, -1.0f, 1.0f,
			...
			0.f, 0.f, 1.f, 0.f, 0.f, 0.f,   // lookAt
			0.f, 1.f, 0.f, 1.f, 100.f);

//        cam[0] = new GLMCamera(GLMCamera::FRUSTUM,
//                               scrWidth, scrHeight,
//                               -1.0f, 1.0f, -1.0f, 1.0f,                // left, right, bottom, top
//							   _scd->camPos.x, _scd->camPos.y, _scd->camPos.z,
//							   			_scd->camLookAt.x, _scd->camLookAt.y, _scd->camLookAt.z,   // lookAt
//							   			_scd->camUpVec.x, _scd->camLookAt.y, _scd->camLookAt.z,
//                               1.f, 100.f);
...
void Cs1Perspective::initProto(ShaderProto* _proto)
{
...
void Cs1Perspective::render(SceneNode* _scene, double time, double dt, unsigned int ctxNr)
{
...
void Cs1Perspective::renderFbos(double time, double dt, unsigned int ctxNr)
{
}

//--------------------------------------------------------------------------------

void Cs1Perspective::preDisp(double time, double dt)
{
}

//--------------------------------------------------------------------------------

void Cs1Perspective::postRender()
{
}

//--------------------------------------------------------------------------------

void Cs1Perspective::onKey(int key, int scancode, int action, int mods)
{
...
void Cs1Perspective::mouseBut(GLFWwindow* window, int button, int action,
		int mods)
{
}
...
void Cs1Perspective::mouseCursor(GLFWwindow* window, double xpos, double ypos)
{
}

//--------------------------------------------------------------------------------

void Cs1Perspective::clearFbo()
{
}
}
