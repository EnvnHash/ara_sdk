...
#ifndef V4L_V4L_STRUCTS_H_
#define V4L_V4L_STRUCTS_H_
...
typedef struct capabilities_s {
  ...
  int supports_rgb32; // V4L2_PIX_FMT_RGB32
  int supports_rgb_bayer_gbrg; // V4L2_PIX_FMT_SGBRG8
  int supports_mjpeg; // V4L2_PIX_FMT_MJPEG
} Videocapabilities_t;

}


#endif /* V4L_V4L_STRUCTS_H_ */
