...
//extern std::function<void()> VideoSource::nvdecVideoEndCb;
...
class VideoSource
{
    public:
        ...
        //          decoded frames.
        VideoSource(const std::string sFileName, FrameQueue *pFrameQueue, bool _loop);
        ...
        void setEndCb(std::function<void()> _cb) { oSourceData_.videoEndCb = _cb; }
