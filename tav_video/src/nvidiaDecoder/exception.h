...
class NvException : public Std_Exception
{
    public:
    ...
    private:
        ...
        NvException(const std::string &str);
...
#define RUNTIME_EXCEPTION( msg) \
		NvException<std::runtime_error>::throw_it( __FILE__, __LINE__, msg)

//! Logic exception in program, e.g. an assert failed
#define LOGIC_EXCEPTION( msg) \
		NvException<std::logic_error>::throw_it( __FILE__, __LINE__, msg)

//! Out of range exception
#define RANGE_EXCEPTION( msg) \
		NvException<std::range_error>::throw_it( __FILE__, __LINE__, msg)
...
////////////////////////////////////////////////////////////////////////////////
template<class Std_Exception>
NvException<Std_Exception>::NvException() :
NvException("Unknown Exception.\n")
{ }
...
////////////////////////////////////////////////////////////////////////////////
template<class Std_Exception>
NvException<Std_Exception>::NvException(const std::string &s) :
    Std_Exception(s)
{ }
...
////////////////////////////////////////////////////////////////////////////////
template<class Std_Exception>
NvException<Std_Exception>::~NvException() throw() { }
