...
extern "C"
bool modInitCTX(sCtxModule *pCtx, const char *filename, std::string exec_path, int nKernels, int nGlobalMem, int nTexRef)
{
    ...
    char* actual_path = sdkFindFilePath(&pCtx->mModuleName, &exec_path);
