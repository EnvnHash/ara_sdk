...
// edited, now we have use a defined  data path, no searching needed

inline char *sdkFindFilePath(std::string *filename, std::string *executable_path)
{
	std::string path((*executable_path)+(*filename));
