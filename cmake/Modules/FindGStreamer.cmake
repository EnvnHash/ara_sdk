...
find_package_handle_standard_args(GSTREAMER DEFAULT_MSG GSTREAMER_LIBRARY GSTREAMER_INCLUDE_DIR)
mark_as_advanced(GSTREAMER_INCLUDE_DIR GSTREAMER_LIBRARY GSTCONFIG_INCLUDE_DIR)
set(GSTREAMER_FOUND "YES")
set(GSTREAMER_LIBRARIES ${GSTREAMER_LIBRARY})
set(GSTREAMER_INCLUDE_DIRS ${GSTREAMER_INCLUDE_DIR} ${GSTCONFIG_INCLUDE_DIR} ${PC_GSTREAMER_INCLUDEDIR})
