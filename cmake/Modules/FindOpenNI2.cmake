...
find_path(OPENNI2_INCLUDE_DIR OpenNI.h
          HINTS ${NESTK_ROOT_DIRS_HINTS} ${PC_OPENNI_INCLUDEDIR} ${PC_OPENNI_INCLUDE_DIRS} /usr/local/include/OpenNI2 /usr/include/ni2
          PATHS "$ENV{PROGRAMFILES}/OpenNI2/Include" "$ENV{PROGRAMW6432}/OpenNI2/Include"
          PATH_SUFFIXES openni ni)
#add a hint so that it can find it without the pkg-config
find_library(OPENNI2_LIBRARY
             NAMES OpenNI2
             HINTS ${NESTK_ROOT_DIRS_HINTS} ${PC_OPENNI_LIBDIR} ${PC_OPENNI_LIBRARY_DIRS} /usr/local/lib/OpenNI2
             PATHS "$ENV{PROGRAMFILES}/OpenNI2/Redist" "$ENV{PROGRAMW6432}/OpenNI2/Redist" "$ENV{PROGRAMW6432}/OpenNI2"
             PATH_SUFFIXES lib lib64
	     )
find_library(XNLIB_LIBRARY
             NAMES XnLib
             HINTS ${NESTK_ROOT_DIRS_HINTS} ${PC_OPENNI_LIBDIR} ${PC_OPENNI_LIBRARY_DIRS} /usr/local/lib/OpenNI2
             PATHS "$ENV{PROGRAMFILES}/OpenNI2/Redist" "$ENV{PROGRAMW6432}/OpenNI2/Redist" "$ENV{PROGRAMW6432}/OpenNI2"
             PATH_SUFFIXES lib lib64
...
if(APPLE)
  set(OPENNI2_LIBRARIES ${OPENNI2_LIBRARY} ${XNLIB_LIBRARY})
else()
  set(OPENNI2_LIBRARIES ${OPENNI2_LIBRARY} ${XNLIB_LIBRARY})
endif()

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(OpenNI2 DEFAULT_MSG OPENNI2_LIBRARY XNLIB_LIBRARY OPENNI2_INCLUDE_DIR)
mark_as_advanced(OPENNI2_LIBRARY XNLIB_LIBRARY OPENNI2_INCLUDE_DIR)
...
if(XNLIB_FOUND)
  message(STATUS "XnLib found (lib: ${XNLIB_LIBRARY})")
endif(XNLIB_FOUND)
