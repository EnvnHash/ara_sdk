...
void SPWorldAxes::sendPar(CameraSet* cs, double time, SceneNode* node, SceneNode* parent, renderPass pass,
                          uint loopNr) {
...
void SPWorldAxes::setScreenSize(uint width, uint height) { s_scrWidth = width, s_scrHeight = height; }
