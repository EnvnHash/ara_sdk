...
SNWorldAxes::SNWorldAxes(sceneData* sd) : SNGridFloor(sd) {
    ...
    // x and z axis
    vector<GLfloat> positions{-1.f, 0.f, -0.0001f, 1.f, 0.f, -0.0001f, 0.f, -1.f, -0.0001f,
                              0.f,  1.f, -0.0001f, 0.f, 0.f, -40.f,    0.f, 0.f,  40.f};

    m_lineVao = make_unique<VAO>("position:3f", GL_STATIC_DRAW);
    m_lineVao->upload(CoordType::Position, &positions[0], 6);
}
