...
public:
    ...
    Quad *getStdQuad() {
        ...
        if (!stdQuad[ctxName])
            stdQuad[ctxName] =
                std::make_unique<Quad>(-1.f, -1.f, 2.f, 2.f, glm::vec3(0.f, 0.f, 1.f), 1.f, 1.f, 1.f, 1.f);
    ...
    Quad *getStdHFlipQuad() {
        ...
        if (!stdHFlipQuad[ctxName])
            stdHFlipQuad[ctxName] = std::make_unique<Quad>(-1.f, -1.f, 2.f, 2.f, glm::vec3(0.f, 0.f, 1.f), 0.f, 0.f,
    ...
    Quad *getStdHalfQuad() {
        ...
        if (!stdHalfQuad[ctxName])
            stdHalfQuad[ctxName] =
                std::make_unique<Quad>(-0.5f, -0.5f, 1.f, 1.f, glm::vec3(0.f, 0.f, 1.f), 1.f, 1.f, 1.f, 1.f);
