...
namespace ara::GLBaseUnitTest::LoadTexture {
    ...
    void staticDrawFunc() {
        ...
        checkColors.push_back(make_tuple(segStepHalf, segStepHalf, glm::ivec3(255, 0, 0)));
        checkColors.push_back(make_tuple(segStep + segStepHalf, segStepHalf, glm::ivec3(0, 255, 0)));
        checkColors.push_back(make_tuple(segStep * 2 + segStepHalf, segStepHalf, glm::ivec3(0, 0, 255)));
        checkColors.push_back(make_tuple(segStep * 3 + segStepHalf, segStepHalf, glm::ivec3(0, 255, 255)));

        checkColors.push_back(make_tuple(segStepHalf, segStep + segStepHalf, glm::ivec3(0, 0, 255)));
        checkColors.push_back(make_tuple(segStep + segStepHalf, segStep + segStepHalf, glm::ivec3(0, 255, 255)));
        checkColors.push_back(make_tuple(segStep * 2 + segStepHalf, segStep + segStepHalf, glm::ivec3(255, 0, 255)));
        checkColors.push_back(make_tuple(segStep * 3 + segStepHalf, segStep + segStepHalf, glm::ivec3(255, 255, 0)));

        checkColors.push_back(make_tuple(segStepHalf, segStep * 2 + segStepHalf, glm::ivec3(255, 0, 255)));
        checkColors.push_back(make_tuple(segStep + segStepHalf, segStep * 2 + segStepHalf, glm::ivec3(255, 255, 0)));
        checkColors.push_back(make_tuple(segStep * 2 + segStepHalf, segStep * 2 + segStepHalf, glm::ivec3(255, 0, 0)));
        checkColors.push_back(make_tuple(segStep * 3 + segStepHalf, segStep * 2 + segStepHalf, glm::ivec3(0, 255, 0)));

        checkColors.push_back(make_tuple(segStepHalf, segStep * 3 + segStepHalf, glm::ivec3(255, 0, 0)));
        checkColors.push_back(make_tuple(segStep + segStepHalf, segStep * 3 + segStepHalf, glm::ivec3(0, 255, 0)));
        checkColors.push_back(make_tuple(segStep * 2 + segStepHalf, segStep * 3 + segStepHalf, glm::ivec3(0, 0, 255)));
        checkColors.push_back(
                make_tuple(segStep * 3 + segStepHalf, segStep * 3 + segStepHalf, glm::ivec3(0, 255, 255)));
