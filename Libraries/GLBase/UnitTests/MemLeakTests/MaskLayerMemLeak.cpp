...
namespace ara::GLBaseUnitTest::MaskLayerMemLeak {
    ...
    TEST(GLBaseTest, MaskLayerMemLeak
    ) {
...
i<10; i++)
{
auto layer = make_unique<MaskLayer>(maskType::Vector,
                                    &shCol);  // create a Quad, standard width and height (normalized into -1|1), static red
layer->
